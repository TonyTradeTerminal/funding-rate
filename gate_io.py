...
spot_set = {item['currency'] for item in spot_data if 'currency' in item}
...
if __name__ == "__main__":
    ...
    'forward_side_spread': 'spr_f',
    'reverse_side_spread': 'spr_r',
    'forward_side_profit': 'profit_f',
    'reverse_side_profit': 'profit_r',
    })
