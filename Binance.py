...
if __name__ == "__main__":
    ...
    df = df[['Time', 'coin','funding_interval', 'funding_rate', 'funding_rate_8h','interest_rate_8h', 'spot_24h_volume', 'futures_24h_volume', 'spot_best_bid','spot_best_ask','future_best_bid','future_best_ask', 'forward_side_spread', 'reverse_side_spread', 'forward_side_profit', 'reverse_side_profit', 'borrowable_value']]
