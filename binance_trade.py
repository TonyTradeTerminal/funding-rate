...
# ③ adlQuantile
adl_map = {
    q["symbol"]: q["adlQuantile"]
    for q in client.papi_get_um_adl_quantile(timestamp=now_ms)
}
time.sleep(0.05)
...
for pos in account["positions"]:
    ...
    records.append({
        ...
        # 资金费率相关
        "freq_h"      : funding_interval_h,        # 真实周期 (h)
        "fr_last_rate": fr_last_rate,              # 上一次费率
        "fr_next_rate": fr_next_rate,              # 下一次费率
